...
<div id="header">
    <div id="logo">
        <h1><a href="list.do">Workspace</a></h1>
    </div>
</div>
<!-- end #header -->
<div id="menu">
    <ul>
        <li class="current_page_item"><a href="list.do">Home</a></li>
        <li><a href="../project/search.do">EmpInfo</a></li>
        <li><a href="../project/list.do">Community</a></li>
        <li><a href="LunchMenu.jsp">LunchMenu</a></li>
    </ul>
</div>